 ...
 * @brief Service for loading USDA FoodData Central datasets into SQLite database
 * 
...
public:
   ...
   * 
   * @param branded_foods Vector of BrandedFood objects to insert into the database
